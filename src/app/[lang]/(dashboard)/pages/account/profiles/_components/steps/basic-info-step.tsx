          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <Label htmlFor="cofinanciacion">Capacidad de Cofinanciación</Label>
                <p className="text-xs text-muted-foreground">
                  ¿Puedes aportar fondos propios para proyectos?
                </p>
              </div>
              <Switch
                id="cofinanciacion"
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <Label htmlFor="socios">Disponible para Socios Europeos</Label>
                <p className="text-xs text-muted-foreground">
                  ¿Estás interesado en colaborar con entidades de otros países de la UE?
                </p>
              </div>
              <Switch
                id="socios"
