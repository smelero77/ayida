  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Revisa los detalles de tu suscripción y gestiona tus opciones de facturación.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="grid gap-6">
          ...
          <div>
            <div className="flex justify-between mb-2 text-sm">
              <p className="text-muted-foreground">Almacenamiento usado</p>
              <p className="font-medium">
        ...
        <div>
          <h4 className="font-semibold mb-2">Actividad de este mes</h4>
      ...
      <CardFooter className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Importe adeudado: {formatCurrency(currentPlanData.billingInfo.amountDue)}
          </p>
        </div>
      </CardFooter>
    </Card>
