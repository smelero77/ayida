        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start space-x-3">
              <button
                ...
                className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-colors ${
                  acceptTerms
                    ? 'bg-[rgb(255,65,90)] border-[rgb(255,65,90)] text-white'
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Acepto los{" "}
                <Link href="/terms" className="text-[rgb(255,65,90)] hover:underline">
                  términos y condiciones
                </Link>{" "}
                y la{" "}
                <Link href="/privacy" className="text-[rgb(255,65,90)] hover:underline">
            ...
            <button
              ...
              className="w-full h-11 rounded-full border border-gray-300 text-gray-700 font-medium hover:bg-gray-50 transition-colors duration-200 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isGoogleLoading ? (
          ...
          <div className="text-center mt-6">
            <p className="text-gray-600 text-sm">
              ...
              <Link
                href="/signin"
                className="text-[rgb(255,65,90)] hover:text-[rgb(255,65,90)]/70 font-medium transition-colors"
              >
                Inicia sesión aquí
              </Link>
            </p>
